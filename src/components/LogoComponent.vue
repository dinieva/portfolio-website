<template>
  <div class="flex flex-row items-end justify-start cursor-pointer">
    <RouterLink to="/" class="flex">
      ...
      >
        <rect id="Icons" x="-1024" y="-128" width="1280" height="800" style="fill: none" />
      ...
      <span class="hover:shadow-3xl tracking-widest">REZEDA DINIEVA</span></RouterLink
    >
  </div>
</template>
